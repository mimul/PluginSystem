...
public class JDBCConfig {
	...
	@Config("test_query")
	public JDBCConfig setTestQuery(String testQuery) {
	...
	public boolean equals(Object o) {
		...
		if (url != null ? !url.equals(that.url) : that.url != null)
			return false;
		if (testQuery != null ? !testQuery.equals(that.testQuery) : that.testQuery != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result + (testQuery != null ? testQuery.hashCode() : 0);
